            ...
            <div class="content-two">
                ...
                <form>
                  <div class="header-search-group">
                    <label><i class="fa fa-search"></i>
                      <input type="text" autocomplete="off" aria-autocomplete="list" aria-controls="react-autowhatever-1" placeholder="Nháº­p tÃªn bÃ i hÃ¡t, ca sÄ© hoáº·c videoâ€¦" value="" class="form-control z-input-placeholder">
                    </label>
                  </div>
                </form>
              </div>
              <div class="list-abum">
                <div class="container">
                  <div class="row">
                  <?php 
            		 $resultdb = mysqli_query($db, "select song.idsong, song.avatarsong, song.namesong, song.tacgia from song, `album-song` where song.idsong = `album-song`.idsong and `album-song`.idal = '3'
");
