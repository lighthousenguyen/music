            ...
            <div class="content-two">
              ...
              <div class="list-abum">
                <div class="container">
                  <div class="row">
                  <?php 
            		 $resultdb = mysqli_query($db, "select song.idsong, song.avatarsong, song.namesong, song.tacgia from song, `album-song` where song.idsong = `album-song`.idsong and `album-song`.idal = '4'
");
